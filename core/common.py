...
BOARD_INFO_LIST = {
    'cse_bachelor':{
        'name' : '컴융-학사공지',
        'slack_channel' : os.getenv('SLACK_CHANNEL_BACHELOR'),
        'url' : CSE_URL_BASE + 'bachelor.do',
        'scraper': Scraper.crawl_cse,
    },
    'cse_notice':{
        'name' : '컴융-일반소식',
        'slack_channel' : os.getenv('SLACK_CHANNEL_NOTICE'),
        'url' : CSE_URL_BASE + 'notice.do',
        'scraper': Scraper.crawl_cse,
    },
    'cse_project':{
        'name' : '컴융-사업단소식',
        'slack_channel' : os.getenv('SLACK_CHANNEL_PROJECT'),
        'url' : CSE_URL_BASE + 'project.do',
        'scraper': Scraper.crawl_cse,
    },
    'cnu_notice': {
        'name' : '충남대-학사정보',
        'slack_channel' : os.getenv('SLACK_CHANNEL_CNU'),
